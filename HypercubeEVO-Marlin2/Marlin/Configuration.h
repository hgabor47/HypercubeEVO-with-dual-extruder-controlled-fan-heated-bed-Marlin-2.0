...
#define HOTEND_OFFSET_X { 0.0, -19.70 } // (mm) relative X-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 80, 80, 5, 50 }
...
//#define Z_SERVO_ANGLES { 50, 140 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+  23,18
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 18, -2.8 }
